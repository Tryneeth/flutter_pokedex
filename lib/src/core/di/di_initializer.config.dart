...
import 'package:flutter_pokedex/src/core/design_system/theme/bloc/theme_bloc.dart'
    as _i18;
import 'package:flutter_pokedex/src/core/di/di_module.dart' as _i23;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.factory<_i19.GetAllPokemonsUsecase>(
        () => _i19.GetAllPokemonsUsecase(gh<_i14.PokemonRepository>()));
    gh.factory<_i20.GetPokemonDetailsUsecase>(
        () => _i20.GetPokemonDetailsUsecase(gh<_i14.PokemonRepository>()));
    gh.factoryParam<_i21.PokedexBloc, _i18.ThemeBloc, dynamic>((
      themeBloc,
      _,
    ) =>
        _i21.PokedexBloc(
          gh<_i19.GetAllPokemonsUsecase>(),
          gh<_i11.PokedexNavigator>(),
          themeBloc,
        ));
    gh.factoryParam<_i22.PokemonDetailsBloc, String, _i18.ThemeBloc>((
      pokemonName,
      themeBloc,
    ) =>
        _i22.PokemonDetailsBloc(
          gh<_i20.GetPokemonDetailsUsecase>(),
