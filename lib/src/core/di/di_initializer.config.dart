...
import 'package:flutter_pokedex/src/core/design_system/theme/bloc/theme_bloc.dart'
    as _i17;
import 'package:flutter_pokedex/src/core/di/di_module.dart' as _i22;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.factory<_i18.GetAllPokemonsUsecase>(
        () => _i18.GetAllPokemonsUsecase(gh<_i14.PokemonRepository>()));
    gh.factory<_i19.GetPokemonDetailsUsecase>(
        () => _i19.GetPokemonDetailsUsecase(gh<_i14.PokemonRepository>()));
    gh.factory<_i20.PokedexBloc>(() => _i20.PokedexBloc(
          gh<_i18.GetAllPokemonsUsecase>(),
          gh<_i11.PokedexNavigator>(),
        ));
    gh.factoryParam<_i21.PokemonDetailsBloc, String, dynamic>((
      pokemonName,
      _,
    ) =>
        _i21.PokemonDetailsBloc(
          gh<_i19.GetPokemonDetailsUsecase>(),
...
class _$HiveIntervaceProvider extends _i22.HiveIntervaceProvider {}

class _$LoggerProvider extends _i22.LoggerProvider {}
